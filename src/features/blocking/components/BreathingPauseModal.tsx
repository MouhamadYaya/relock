...
/**
 * Le rituel « respiration » : six secondes d'attente pendant lesquelles
 * l'orbe inspire puis expire, et rien d'autre à faire.
 *
 * C'est le rituel le plus doux des trois — il occupe l'attention sans rien
 * demander. Le décor, la sortie et le changement de rituel viennent de
 * `PauseRitualShell`, partagée avec le calcul et la transcription.
 */
