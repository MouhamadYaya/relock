...
RCT_EXTERN_METHOD(drainExtensionLog
                  : (RCTPromiseResolveBlock)resolve
                  rejecter : (RCTPromiseRejectBlock)reject)

RCT_EXTERN_METHOD(publishSentryDSN
                  : (nonnull NSString *)dsn
                  resolver : (RCTPromiseResolveBlock)resolve
                  rejecter : (RCTPromiseRejectBlock)reject)
...
RCT_EXTERN_METHOD(consumePendingShieldRequest
                  : (RCTPromiseResolveBlock)resolve
                  rejecter : (RCTPromiseRejectBlock)reject)
...
// Simulation du quota atteint — build de développement uniquement.
#if DEBUG
RCT_EXTERN_METHOD(homeReferenceFixture
                  : (RCTPromiseResolveBlock)resolve
                  rejecter : (RCTPromiseRejectBlock)reject)

RCT_EXTERN_METHOD(simulateLimitReached
                  : (nonnull NSString *)ruleId
