...
final class NativeDurationPickerView: UIView {
  ...
  /// Nom volontairement distinct de `onChange` : `topChange` est déjà un
  /// événement bubbling côté RN, le réutiliser en direct event fait planter le
  /// renderer JS au montage.
  ...
  @objc private func valueChanged() {
    ...
    onDurationChange?(["minutes": selected])
  }
